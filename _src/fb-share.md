...
2. You need to add these HTML meta tags into page in the <head></head>. It will not work if you put it in the <body></body>. Make sure to customize per your a) image, b) description, c) URL, and d) title.
...
5. If you are having trouble… you can debug it with this Facebook tool. It looks more geeky than it is. It tells you what Facebook is seeing when you post in the URL to share.
